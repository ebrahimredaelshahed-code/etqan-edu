...
const dict = {
  ar: {
    ...
    searchUsers: "بحث بالاسم أو رقم الهاتف",
    myCategories: "الأقسام المشترك بها",
    savedPassword: "كلمة المرور المسجلة",
    subscribeAndView: "الاشتراك وعرض الدروس",
    noCategories: "لم تشترك في أي قسم بعد",
  ...
  en: {
    ...
    subscribeAndView: "Subscribe & view lessons",
