...
const dict = {
  ar: {
    ...
    subscriptionPhone: "رقم واتساب استلام الكود لهذا القسم",
    ...
    tabAdmins: "الإدارة",
    manageCatalog: "إدارة المواد والباكيدجات",
    addCategory: "إضافة مادة",
    categoryNameAr: "اسم المادة (عربي)",
    categoryNameEn: "اسم المادة (إنجليزي)",
    slug: "المعرف (بالإنجليزية)",
    addCourse: "إضافة باكيدج",
    courseTitleAr: "اسم الباكيدج (عربي)",
    courseTitleEn: "اسم الباكيدج (إنجليزي)",
    coursePrice: "سعر الباكيدج",
    courseDuration: "مدة الباكيدج بالساعات",
    courseInstructor: "محاضر الباكيدج",
    courseImage: "رابط صورة الباكيدج",
    category: "المادة",
    ...
    adminCategory: "المادة المخصصة",
    adminPermissions: "صلاحيات التبويبات",
    permissionCodes: "الأكواد",
    permissionCatalog: "المواد والدورات",
    permissionVideos: "الفيديوهات والدروس والاختبارات",
    permissionUsers: "المستخدمون",
    revokeAdmin: "سحب صلاحيات الإدارة",
    confirmRevokeAdmin: "هل تريد سحب صلاحيات الإدارة من هذا المستخدم؟",
    selectAdminCategory: "اختر المادة",
    ...
    allCategories: "كل المواد",
    allCourses: "كل الباكيدجات",
    exportExcel: "تصدير Excel",
    deleteUser: "حذف المستخدم",
    confirmDeleteUser: "هل تريد حذف هذا المستخدم نهائياً؟",
    subscribedCategories: "المواد المشترك بها",
    subscribedCourses: "الباكيدجات المشترك بها",
    myPassword: "كلمة المرور الخاصة بي",
    showPassword: "إظهار",
    hidePassword: "إخفاء",
    passwordNotStored: "غير متاحة، يرجى تغييرها لتظهر هنا",
    deleteCode: "حذف الكود",
    courseImageUpload: "استيراد صورة الباكيدج",
  ...
  en: {
    ...
    subscriptionPhone: "WhatsApp number for receiving this section's code",
    ...
    tabVideos: "Videos",
    tabAdmins: "Admins",
    manageCatalog: "Manage subjects and packages",
    addCategory: "Add subject",
    categoryNameAr: "Subject name (Arabic)",
    categoryNameEn: "Subject name (English)",
    slug: "Slug",
    addCourse: "Add package",
    courseTitleAr: "Package title (Arabic)",
    courseTitleEn: "Package title (English)",
    coursePrice: "Package price",
    courseDuration: "Package duration in hours",
    courseInstructor: "Package instructor",
    courseImage: "Package image URL",
    category: "Subject",
    ...
    adminCategory: "Assigned subject",
    adminPermissions: "Tab permissions",
    permissionCodes: "Codes",
    permissionCatalog: "Subjects and courses",
    permissionVideos: "Videos, lessons and quizzes",
    permissionUsers: "Users",
    revokeAdmin: "Revoke admin access",
    confirmRevokeAdmin: "Revoke admin access from this user?",
    selectAdminCategory: "Select a subject",
    ...
    allCourses: "All packages",
    exportExcel: "Export Excel",
    deleteUser: "Delete user",
    confirmDeleteUser: "Delete this user permanently?",
    subscribedCategories: "Subscribed subjects",
    subscribedCourses: "Subscribed packages",
    myPassword: "My password",
    showPassword: "Show",
    hidePassword: "Hide",
    passwordNotStored: "Not available, change it to show here",
    deleteCode: "Delete code",
    courseImageUpload: "Upload package image",
