...
const dict = {
  ar: {
    ...
    adminSubjects: "المواد المخصصة للمشرف",
    saveSubjects: "حفظ المواد",
    removeAdmin: "إزالة صلاحية الإدارة",
    confirmRemoveAdmin: "هل تريد إزالة صلاحية الإدارة؟ سيبقى الحساب والبيانات محفوظة.",
    adminRemoved: "تمت إزالة صلاحية الإدارة",
  ...
  en: {
    ...
    confirmRemoveAdmin: "Remove admin access? The account and data will be kept.",
